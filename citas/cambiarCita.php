...
$consulta = "SELECT horaCita, usuario FROM citas WHERE idCita='" . $_POST["citaSeleccionada"] . "';";
$hacerConsulta = $conexion->query($consulta, $conexion);

$datosDeLaCita = mysqli_fetch_array($hacerConsulta, MYSQLI_ASSOC);
...
<head>
  ...
  <script language="javascript" type="text/javascript">
    function mostrarDatos() {
      ...
      document.getElementById("usuario").value = "<?php echo ($usaurioAct); ?>";
    }
...
<body onLoad="javascript:mostrarDatos();">
  <form action="" method="post" name="formularioNuevaCita" id="formularioNuevaCita">
    ...
    <table width="500" border="0" cellspacing="0" cellpadding="4">
      ...
      <tr>
        <td colspan="4"><textarea name="usuario" cols="70" rows="5" wrap="VIRTUAL" id="usuario">
          </textarea></td>
      </tr>
    </table>
