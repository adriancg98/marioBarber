    ...
    if (!empty($_POST)){
        ...
        if (count($errors) == 0){
            ...
            if ($registro > 0){
                ...
                $cuerpo = "Estimado $nombre: <br /><br />Para continuar con el proceso de registro, es indispensable que <a href='$url'>active su cuenta</a>";

                if (enviarEmail($email, $nombre, $asunto, $cuerpo)){

                    echo "Para finalizar el proceso de registro siga las instrucciones que hemos enviado al correo electrónico: $email";
